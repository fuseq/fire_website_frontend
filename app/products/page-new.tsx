...
import { ChevronDown, Search, Filter, Grid, List, ShoppingCart, Star, TrendingUp } from "lucide-react"
...
export default function ProductsPage() {
  ...
  let filteredProducts = products.filter((p) => {
    const matchesCategory = selectedCategory === "Tüm Ürünler" || p.category === selectedCategory
                  ...
                  {filteredProducts.map((product) => (
                    viewMode === "grid" ? (
                      ...
                      >
                        ...
                        <div className="p-5">
                          <Link href={`/product/${product.id}`}>
                            <h3 className="font-bold text-gray-900 mb-2 line-clamp-2 hover:text-red-600 transition min-h-[3rem]">
                              {product.name}
                            </h3>
                          </Link>
